...
import { Cloud, Sun, CloudRain, Droplets, Wind, Thermometer, MapPin } from 'lucide-react';
...
const weatherData = {
  ...
  forecast: [
    ...
    { day: 'Wed', temp: 27, icon: 'rain' },
    { day: 'Thu', temp: 30, icon: 'sun' },
    { day: 'Fri', temp: 32, icon: 'sun' },
  ],
};
      ...
      <div className="relative z-10">
        ...
        <div className="flex items-center justify-between mb-5">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Feels like <span className="font-semibold text-foreground">{weatherData.feelsLike}°</span>
              </p>
            </div>
          </div>
          ...
          <div className="hidden sm:flex flex-col gap-2">
            <motion.div 
              className="clay-inset px-3 py-2 rounded-xl flex items-center gap-2"
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm font-bold">{weatherData.windSpeed} km/h</p>
              </div>
            </motion.div>
          </div>
        </div>
          ...
          >
            ...
            <div>
              <p className="text-sm font-semibold text-foreground">
                {weatherData.rainChance}% {t('rainAlert')}
              </p>
